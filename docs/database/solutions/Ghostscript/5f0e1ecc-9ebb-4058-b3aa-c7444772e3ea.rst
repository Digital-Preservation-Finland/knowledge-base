.. _5f0e1ecc-9ebb-4058-b3aa-c7444772e3ea:

==========================================================
A stream keyword was not terminated with a linefeed (0x0A)
==========================================================
...
.. list-table::
   ...
   * - application/pdf
     ...
     - 
     - 
     - `OPF <https://github.com/openpreserve/format-corpus/corpus/format-corpus/jhove-errors/PDF-HUL-140/67282617093022525134485263930000992465.pdf>`__
...
::
	...
	Ghostscript:	A stream keyword was not terminated with a linefeed (0x0A)
